...
class LightModeColors {
  static const lightPrimary = Color(0xFF2E7D32); // Deep green for parking/location
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFE8F5E8);
  static const lightOnPrimaryContainer = Color(0xFF0D2818);
  static const lightSecondary = Color(0xFF1976D2); // Navigation blue
  static const lightOnSecondary = Color(0xFFFFFFFF);
  static const lightTertiary = Color(0xFFFF6B35); // Accent orange
...
class DarkModeColors {
  ...
  static const darkSecondary = Color(0xFF64B5F6); // Light blue for navigation
  static const darkOnSecondary = Color(0xFF0D47A1);
  static const darkTertiary = Color(0xFFFF8A65); // Light orange accent
